...
const {handleMyProfile,handleDisplayProfile,handleAddProject,handleUpdateProject,handleDeleteProject,handleAddEdu,updateEdu,deleteEdu,addExp,updateExp,deleteExp}=require('../Controllers/UserStuController')
...
router.post('/profile/updateeducation/:id', AuthenticateUser,restrictTo(["Student"]), updateEdu)
