        ...
        <>
            <div className="ReqItem">
                ...
                <div className="Reqbtns">
                    <button type="button" className="btn btn-success mx-3" onClick={()=>acceptReq(req._id,Remark)}>Accept</button>
                    <button type="button" className="btn btn-danger mx-3" onClick={()=>rejectReq(req._id,Remark)}>Reject</button>
                </div>
            </div>
        </>
    )
